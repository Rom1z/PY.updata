...
import ccxt
import matplotlib
matplotlib.use("QtAgg")  # для PySide6
...
class App(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Crypto/Forex TA Desktop App")
        ...
        self.cmb_exchange.addItems(SUPPORTED_EXCHANGES.keys())
        self.cmb_tf = QComboBox()
        self.cmb_tf.addItems(["1m","5m","10m","15m","30m","1h","4h","1d"])
        self.ed_symbol = QLineEdit()
        self.ed_symbol.setPlaceholderText("Symbol (e.g., XAUUSD)")
        self.btn_load = QPushButton("Load Markets")
        self.btn_fetch = QPushButton("Fetch Signal")
        controls.addWidget(QLabel("Exchange:"))
        controls.addWidget(self.cmb_exchange)
        controls.addWidget(QLabel("TF:"))
        controls.addWidget(self.cmb_tf)
        controls.addWidget(self.ed_symbol)
        controls.addWidget(self.btn_load)
        controls.addWidget(self.btn_fetch)
        vbox.addLayout(controls)

        # --- Результаты ---
        box = QGroupBox("Signal Result")
        ...
        self.lbl_tp3 = QLabel("—")
        self.lbl_sl = QLabel("—")
        self.lbl_reason = QTextEdit()
        self.lbl_reason.setReadOnly(True)
        grid.addWidget(QLabel("Resolved:"), 0, 0)
        grid.addWidget(self.lbl_resolved, 0, 1)
        grid.addWidget(QLabel("Side:"), 1, 0)
        grid.addWidget(self.lbl_side, 1, 1)
        grid.addWidget(QLabel("Conf:"), 2, 0)
        grid.addWidget(self.lbl_conf, 2, 1)
        grid.addWidget(QLabel("TP1:"), 3, 0)
        grid.addWidget(self.lbl_tp1, 3, 1)
        grid.addWidget(QLabel("TP2:"), 4, 0)
        grid.addWidget(self.lbl_tp2, 4, 1)
        grid.addWidget(QLabel("TP3:"), 5, 0)
        grid.addWidget(self.lbl_tp3, 5, 1)
        grid.addWidget(QLabel("SL:"), 6, 0)
        grid.addWidget(self.lbl_sl, 6, 1)
        grid.addWidget(QLabel("Reasons:"), 7, 0)
        grid.addWidget(self.lbl_reason, 7, 1, 3, 1)
        vbox.addWidget(box)
